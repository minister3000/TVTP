...
//XXXX
//XXXX                                              Dissertation Effort
//XXXX                                                 Working Title:
//XXXX                                   The Application of Regime Switch Models with
//XXXX                              Time Varying Transition Probabilities to Solving the
//XXXX                                            Credit Spread Puzzle
//XXXX
//XXXX                         Required c++ code accompanying R-package for package compilation
//XXXX
//XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
//---------------------------------------------------------------------------------------------------------------------------
// LogLikeliHood_FULL
// Returns the log-likelihood of a observing the supplied 'datax' given 'param'. Additional value are provided for diagnostics,
...
// Added new functionality: Allowed for up to 10 process_explanatory variables, formerly only 7
// Last changed: 07/13/2019
//---------------------------------------------------------------------------------------------------------------------------
